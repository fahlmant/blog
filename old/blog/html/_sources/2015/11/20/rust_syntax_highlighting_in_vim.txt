...
First, you'll need Vundle_ if you don't have it. Vundle is a great tool for Vim, managing plugins and making them configurable in your ``.vimrc``.
...
Now to get the Rust highlighting. I'm using this_ repo, which has worked pretty great for me so far. All you need to do to use it is to add this line before the call to ``vundle#end``::
...
.. _this: https://github.com/wting/rust.vim
