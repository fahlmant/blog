...
Supermicro MIBs, its easy. That tool can be found here. 
...
Follow the docs to log in and set up a Prometheus data source. Then, import this as a Dashboard. Assuming everything was set up right,
